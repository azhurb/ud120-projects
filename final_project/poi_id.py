...
#    org_dict.append( (name, data["salary"], data["bonus"]) )
#org_dict.sort(key=lambda x : x[1])
#print org_dict
...
#for idx in range(0, len(data_dict)):
#    my_dataset.append( (ages[idx][0], net_worths[idx][0], math.pow(predictions[idx][0] - net_worths[idx][0], 2)) )
...
#clf = LogisticRegression(C=100000, class_weight='balanced', dual=False,
